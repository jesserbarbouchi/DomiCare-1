...
export default () => {
    ...
    const post = () => {
        ...
        Axios.post("http://192.168.11.124:3000/ServiceProvider/shareservice/", {
            formData,
                ...
                <>
                    ...
                    >
                        ...
                        <Collapse isOpen={showF}>
                            <Alert w="100%" status="error">
                                <VStack space={1} flexShrink={1} w="100%">
                                    ...
                                    >
                                        your service is not shared you need to
                                        try again
                                    </Box>
                                </VStack>
                            </Alert>
                        ...
                        <Collapse isOpen={showS}>
                            <Alert w="100%" status="success">
                                <VStack space={1} flexShrink={1} w="100%">
                                    ...
                                    >
                                        go and check your dashbord and you will
                                        find the service you just shared
                                    </Box>
                                </VStack>
                            </Alert>
                        </Collapse>
                        <Stack p="4" space={3}>
                            ...
                            <Text fontWeight="400">
                                my Dear you can here share your service with the
                                easy way just check your information carefully
                                when you fill them all you need to do is click
                                (share you servce here) and start to fill
                            </Text>
                            <HStack
                                alignItems="center"
                                space={4}
