...
const EditProfile = ({navigation}) => {
  ...
  useEffect(() => {
    axios.get(`http://192.168.161.210:3000/editprofile/fetch/${userData.userData._id}`)
        .then(res => {
...
var profile = () => {
  ...
  const submit = () =>{
    axios.put(`http://192.168.161.210:3000/editprofile/${userData.userData._id}`,{formData})
    .then(res=>{
      console.log("res",res);
      var user = res.data
