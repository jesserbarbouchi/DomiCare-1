...
const userEquipements = ({ navigation }) => {
    ...
    const getEquip = () => {
        axios
            .get(`http://192.168.11.137:3000/Equipements/equip/${formData._id}`)
            .then((res) => {
                // console.log("equipement id",res);
                // setmyData(res.data)
    ...
    const saveEquipement = () => {
        ...
        axios
            .post(`http://192.168.11.137:3000/Equipements/saveEquip`, {
                formData,
            })
            .then((response) => {
    ...
    const myDelete = () => {
        console.log("ownerId", formData.ownerId);
        axios
            .delete(`http://192.168.11.137:3000/Equipements/${myData.ownerId}`)
            .catch((error) => {
                console.log(error);
            });
    };
