...
const EditEquipement = ({navigation}) => {
  ...
  useEffect(()=>{
    ...
    axios.get(`http://192.168.11.73:3000/Equipements/${userData.userData._id}`)   ///Equipements/${userData.userData._id}
    .then(res => {
      var user = res.data
      setData(res.data)
      setmyData(res.data)
  ...
  const submit = () =>{
    ...
    axios.put(`http://192.168.11.73:3000/Equipements/update/${formData[0]._id}`,{formData})
    .then((res)=>{
