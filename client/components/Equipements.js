var items=[
  { id:1, name: 'Oxygéne machine', price: '1000dt',description:"this is the first oxygéne machine",city:"Tunis",delivery:"delivery included",picture:"https://img.joomcdn.net/1c77be34506edd60a9d0d6f1a0813b8d9dba0d54_1024_1024.jpeg"},
  { id:2, name: 'Oxygéne machine2', price: '500dt',description:"this is the second oxygéne machine",city:"Sousse",delivery:"delivery included",picture:"https://medeor.de/dateien/Non-Profit-Pharmaceuticals/Medical-supplies-and-devices/Medizintechnik/Oxygen-concentrators/action-medeor-oxygen-concentrator-JAY-5BW-Web.jpg"},
  { id:3, name: 'Oxygéne machine3', price: '150dt',description:"this is the third oxygéne machine",city:"Bizerte",delivery:"without delivery",picture:"https://cdn.manomano.com/images/images_products/13848936/P/23574848_1.jpg"},
  { id:4, name: 'Oxygéne machine3', price: '190dt',description:"this is the forth oxygéne machine",city:"Manouba",delivery:"without delivery",picture:"https://m.media-amazon.com/images/I/6127GLu7xaS._AC_SX425_.jpg"}
]
...
//               <Button onPress={myAlert} style={styles.appButtonContainer} >Delete</Button>
...
//           setData({...formData,delivery:DeliveryValue,ownerId:userData.userData._id})
//         }} >
